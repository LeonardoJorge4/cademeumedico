...
<html lang="<?php echo Yii::$app->language; ?>">
    <head>
        ...
        <link rel="stylesheet" href="/assetsAdmin/css/admin.css">
                    ...
                    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                        <div class="sidebar-sticky pt-3">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo Url::to(['/admin/medicos']); ?>">
                                        <span data-feather="file"></span>
                                        Médicos
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo Url::to(['/admin/especialidades']); ?>">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo Url::to(['/admin/medico-has-especialidades']); ?>">
                                        <span data-feather="users"></span>
                                        MédicoEspecialidade
                                    </a>
                                </li>
